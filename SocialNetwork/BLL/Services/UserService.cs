...
namespace SocialNetwork.BLL.Services
{
    public class UserService
    {
        ...
        public void AddFriend(UserAddFriendData data)
        {
            var findUserEntity = userRepository.FindByEmail(data.FriendEmail);
        ...
        {
            if (this.friendRepository.Delete(userId, friendId) == 0)
                throw new Exception();
        }
